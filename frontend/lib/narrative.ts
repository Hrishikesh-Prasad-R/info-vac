...
/**
 * Parse inline **bold** markdown within a plain text string.
 * Returns an array of {text, bold} segments for rendering.
 * Handles consecutive **...** spans correctly.
 */
...
/** Used in the browser UI — emoji renders fine in all browsers. */
export const WATERMARK_TEXT = "Generated by InfoVac❤️ - Autonomous Competitive Intelligence Agent";

/** Used in react-pdf — Helvetica has no emoji glyphs; heart is rendered separately as SVG in the PDF header. */
export const WATERMARK_TEXT_PDF = "Generated by InfoVac - Autonomous Competitive Intelligence Agent";
